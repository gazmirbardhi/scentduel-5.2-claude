...
export const FRAGRANCES: Fragrance[] = [
  ...
  },
  {
    ...
    blurb:
      "The saffron-amber that redefined the sweet-niche genre. Cotton-candy warmth cut by a mineral ambergris edge — instantly recognisable and impossibly loud for something so refined.",
    occasions: ["autumn", "winter", "date-night", "formal", "beast-mode"],
  },
  {
    ...
    typicalPriceUSD: 145,
    notes: {
      top: ["Ambrette Seed", "Sea Salt"],
      heart: ["Sage", "Grapefruit"],
      base: ["Red Algae", "Cashmeran"],
    },
    blurb:
      "A windswept-coast scent — salty, dry, woody-herbal. The anti-gourmand: nothing sweet, nothing loud, just the smell of a cliff walk. Quiet and short but unmistakable.",
    occasions: ["spring", "summer", "autumn", "casual", "office"],
  },
  {
    ...
    notes: {
      ...
      heart: ["Lavender", "Geranium", "Violet", "Jasmine"],
      base: ["Vanilla", "Cardamom", "Sandalwood", "Guaiac Wood", "Patchouli"],
    },
    blurb:
      "Apple-lavender-vanilla over a woody-oriental base. The gateway niche scent — sweet enough to please a crowd, complex enough to feel expensive. Projects hard and lasts.",
    occasions: ["autumn", "winter", "spring", "date-night", "formal", "casual"],
  },
  {
    ...
    typicalPriceUSD: 220,
    notes: {
      top: ["Bergamot", "Green Notes", "Saffron", "Cardamom"],
      heart: ["Bulgarian Rose", "Jasmine", "Cyclamen", "Nutmeg"],
      base: ["Leather", "Oud", "Amber", "Vanilla", "Cedar", "Sandalwood"],
    },
    blurb:
      "A dark rose over leather and oud — the 'Turkish rose market at dusk' scent. Rich, smoky, slightly animalic. One of the most cinematic rose-ouds at the designer-niche price point.",
    occasions: ["autumn", "winter", "date-night", "formal"],
  },
  {
    id: "aesop-hwyl",
    ...
    notes: {
      top: ["Hinoki", "Cypress"],
      heart: ["Moss", "Thyme"],
      base: ["Cedar", "Vetiver", "Patchouli", "Incense"],
    },
    blurb:
      "A Japanese forest in a bottle — hinoki, cypress, moss and smoky incense. Earthy, dry, meditative. The reference 'walk in the woods' scent for people who find Aventus too loud.",
    occasions: ["autumn", "winter", "spring", "office", "casual"],
  },
];
